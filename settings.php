...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configduration('tool_objectbackup/maxtaskruntime',
        new lang_string('settings:maxtaskruntime', 'tool_objectbackup'),
        new lang_string('settings:maxtaskruntime_help', 'tool_objectbackup'),
        30 * MINSECS,
        MINSECS));
